...
This project is a two-page website created with a defined [template](#credits). Project is based on fake event. All people, names, cities and venue are generated by free AI generators and/or by project [author](#authors). Images used in project are not licensed.

Project is built as a final project of Microverse module 1 (Capstone project).
